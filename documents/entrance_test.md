...
- 自分が**持っている/いないスキルは何か(Can)**
    - プログラミングスキル以外で、Willを実現するために必要なヒューマンスキルは何か。
 ...
 **これはしっかり読んで下さい。**
 ...
 #### BrainsのVision, How, Mindについて
 
 以下のリンクにBrainsが活動するうえでの、目標、方向性、考え方などをまとめたものです。
 入部希望の方は熟読してください。これに一切同意できない。これらを「良いもの」として一切捉えられない人は、ぶっちゃけ他の団体を探したほうがいいです。
 - [Vision, How, Mind](https://github.com/brains-tsukuba/Info-and-Rules#vision-how--brains-mind)
